...
// Approximate infrared absorption coefficients (m²/kg) at reference conditions.
...
export function computeGasOpticalDepth(gasMixingRatios, pressureBar, temperatureK) {
  ...
  return {
    ...
    pressureBar,
    temperatureK,
    note: 'Simplified gas opacity lookup: not validated against HITRAN or petitRADTRANS.'
  };
}

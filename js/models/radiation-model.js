...
export class RadiationModel {
  ...
  // simplified UV estimate: not a validated surface dose model. Upgrade: use a photochemical UV model with actual stellar SED.
  ...
  // simplified cosmic ray flux: no modulation model or energy spectrum. Upgrade: use a particle transport model.

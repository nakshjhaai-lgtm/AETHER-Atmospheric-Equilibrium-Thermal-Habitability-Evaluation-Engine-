...
export class RadiationModel {
  ...
  // Estimate UV flux at the surface (W/m², UV-B + UV-C, 200-320nm)
  // Very rough scaling from stellar UV and atmospheric absorption
  ...
  _stellarUVFlux() {
    ...
    const luminositySolar = Math.pow(1, 2) * Math.pow(5780, 4) / Math.pow(5780, 4); // placeholder
  ...
  // Estimate cosmic ray flux at surface (simplified)

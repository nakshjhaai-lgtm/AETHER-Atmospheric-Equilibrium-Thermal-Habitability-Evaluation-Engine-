...
export class AdvancedClimateSolver {
  ...
  _stellarSpectrum(teff, fluxTotal) {
    // ponytail: Planck-function approximation at 10 discrete wavelengths.
  ...
  solve(models) {
    ...
    // ponytail: surface temperature computed from Eddington formula (single-pass).
    ...
    return {
      ...
      provenance: {
        ...
        assumptions: ['1D radiative-convective with convergence loop', 'ponytail: gas opacity from lookup tables, not HITRAN. Upgrade: integrate correlated-k or petitRADTRANS.', 'Rayleigh scattering', 'Dry/moist convective adjustment', 'Cloud-albedo feedback', 'Planck-function spectrum', 'No atmospheric dynamics'],

  ...
  if (btnImport) {
    btnImport.addEventListener('click', () => {
      try {
        ...
        // Mark that a scenario was imported: prevents legacy UI from overwriting
        state._scenarioImported = true;
        state._importedFidelity = data.model_fidelity ?? 'reduced';
...
export function renderQHFResult(result, _renderer, _mode) {
